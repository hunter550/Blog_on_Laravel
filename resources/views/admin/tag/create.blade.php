                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Добавление Тегов v1</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <form action="{{route('tag.store')}}" method="POST" class="">
                            ...
                            <div class="card-body col-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Введите название тега" value="{{old('title')}}">
                                    @error('title')
