                        ...
                        <form action="{{route('category.update', $category->id)}}" method="POST" class="">
                            ...
                            <div class="card-body col-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Введите название категории" value="{{$category->title}}">
                                    @error('title')
                                ...
                                {{--<div class="col-4">
                                    <a href="{{route('category.index')}}" class="btn btn-block btn-primary ">Назад</a>
                                </div>--}}
                        </form>
                    </div>
